    ...
    return (
        <section className="bg-white pb-20 overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative">
                ...
                <div className="hidden md:block absolute top-0 right-10 w-24 h-24 bg-[#FFEB3B] rounded-full animate-spin-slow" style={{ clipPath: 'polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)' }}></div>

                {/* Curly Arrow (Left) */}
                <div className="hidden md:block absolute left-10 top-20">
                ...
                <div className="flex flex-row justify-center gap-4 md:gap-32 mb-24 relative z-10">
                    ...
                    <div className="relative group">
                        <div className="w-36 h-36 md:w-80 md:h-80 bg-[#FA8072] rounded-full flex items-center justify-center relative overflow-visible shadow-xl">
                    ...
                    <div className="relative group">
                        {/* Blue Circle */}
                        <div className="w-36 h-36 md:w-80 md:h-80 bg-[#2962FF] rounded-full flex items-center justify-center relative overflow-visible shadow-xl">
                ...
                {/* Bottom Banner Card */}
                <div className="relative w-full max-w-5xl mx-auto h-[250px] md:h-[500px] bg-[#0091EA] rounded-[30px] md:rounded-[60px] overflow-hidden flex items-center shadow-2xl">

                    {/* Left Poster */}
                    <div className="block w-1/3 h-full p-2 md:p-8 relative z-10">
                        <div className="w-full h-full bg-black/20 rounded-xl md:rounded-3xl overflow-hidden rotate-[-5deg] transform translate-y-2 md:translate-y-4 border-2 md:border-4 border-white/50 shadow-lg">
                    ...
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-30">
                        <div className="w-32 h-32 md:w-96 md:h-96 bg-gradient-to-br from-yellow-400 via-orange-500 to-red-600 flex items-center justify-center text-center p-2 md:p-6 animate-pulse-slow shadow-2xl" style={{ clipPath: 'polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)' }}>
                    ...
                    <div className="absolute right-0 top-1/2 -translate-y-1/2 h-full w-1/2 md:w-1/2 flex items-center justify-end z-20">
                        <img src={cartoonReady} alt="Pro Duo" className="h-[120%] md:h-[140%] object-contain drop-shadow-2xl -mr-4 md:-mr-20" />
                    </div>
