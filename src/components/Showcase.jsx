    ...
    return (
        <section className="relative pt-32 pb-48 bg-darkNavy z-20">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                {/* Watermark */}
                <div className="absolute top-1/2 left-4 transform -translate-y-1/2 hidden lg:flex flex-row items-center justify-center select-none opacity-5 gap-4">
            ...
            <div className="container mx-auto px-4 text-center relative z-10">
                <h2 className="text-6xl md:text-8xl font-black text-white leading-none tracking-tighter mb-4">
                    <div>ARE YOU READY</div>
                    <div className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">FOR PROJECT</div>
                </h2>

                <button className="mt-12 group bg-white text-black px-10 py-4 rounded-full font-bold text-lg flex items-center justify-center gap-3 mx-auto hover:bg-gray-100 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] cursor-pointer">
            ...
            <div className="container mx-auto px-4 mt-40 relative z-20">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 -mb-20 md:-mb-64">
                    {cards.map((card, index) => (
                        <div key={index} className="group relative rounded-3xl overflow-hidden aspect-[3/4.5] cursor-pointer shadow-2xl hover:-translate-y-4 transition-transform duration-500">
                            <img
                                src={card.img}
