                ...
                <div className="flex justify-center relative">
                    ...
                    <div className="relative">
                        ...
                        <motion.div 
                            ...
                            className="absolute top-0 -right-20 md:-right-32 bg-[#2D1B4E] text-white p-6 rounded-full w-32 h-32 md:w-40 md:h-40 flex items-center justify-center text-center leading-tight shadow-lg transform rotate-12"
                        >
